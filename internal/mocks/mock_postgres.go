...
// Source: internal/handler/handlers.go (interfaces: Pinger)
//
// Generated by this command:
//
//	mockgen -destination=internal/repository/mock_postgres.go -package=mocks internal/handler/handlers.go Pinger
//
